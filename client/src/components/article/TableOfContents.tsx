...
function TableOfContents({ headings, activeHeadingId }: TableOfContentsProps) {
  ...
  return (
    <div className="sticky top-24 bg-[#14141E] p-5 rounded-lg border border-white/10">
      <h2 className="font-space font-bold text-lg mb-3">Table of Contents</h2>
      ...
      <div className="mt-6 pt-4 border-t border-white/10">
        <Button 
          ...
          className={`w-full ${isBookmarked ? "bg-purple-900/30 text-purple-500" : ""}`}
        ...
        <div className="flex justify-center space-x-3 mt-3">
          <Button 
            size="icon" 
            variant="ghost" 
            className="text-white/70 hover:text-purple-500 transition"
