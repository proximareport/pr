          ...
          <CardContent className="p-4">
            ...
            {!previewMode ? (
              <div>
                ...
                <div className="mb-6 bg-[#1E1E2D] rounded-lg border border-white/10 shadow-lg overflow-hidden">
                  <div className="border-b border-white/10 p-4">
                    <h3 className="text-lg font-medium mb-1">Add Content Blocks</h3>
                    <p className="text-sm text-white/60">Choose from different block types to build your article</p>
                  </div>
                  
                  <div className="p-4">
                    <Tabs defaultValue="basic" className="w-full">
                      <TabsList className="w-full grid grid-cols-3 bg-[#14141E] border border-white/10 rounded-md mb-3">
                        <TabsTrigger 
                          value="basic" 
                          className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary rounded-md"
                        >
                          <Type className="h-4 w-4 mr-2 inline" /> Basic
                        </TabsTrigger>
                        <TabsTrigger 
                          value="media" 
                          className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary rounded-md"
                        >
                          <ImageIcon className="h-4 w-4 mr-2 inline" /> Media & Interactive
                        </TabsTrigger>
                        <TabsTrigger 
                          value="advanced" 
                          className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary rounded-md"
                        >
                          <Settings2 className="h-4 w-4 mr-2 inline" /> Advanced
                        </TabsTrigger>
                      </TabsList>
                      
                      <TabsContent value="basic" className="pt-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        <Button
                          variant="outline"
                          size="lg"
                          className="h-auto py-3 px-4 border-white/10 bg-[#14141E] hover:bg-white/10 justify-start"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Basic text paragraph</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            <div className="flex items-center mb-1">
                              <Heading2 className="h-4 w-4 mr-2 text-primary" /> 
                              <span className="font-medium">Heading</span>
                            </div>
                            <span className="text-xs text-white/60">Section titles</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Bulleted list items</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Highlighted quotation</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            <div className="flex items-center mb-1">
                              <SeparatorHorizontal className="h-4 w-4 mr-2 text-primary" /> 
                              <span className="font-medium">Divider</span>
                            </div>
                            <span className="text-xs text-white/60">Section separator</span>
                          </div>
                        </Button>
                      </TabsContent>
                      
                      <TabsContent value="media" className="pt-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        <Button
                          variant="outline"
                          size="lg"
                          className="h-auto py-3 px-4 border-primary/30 bg-primary/10 hover:bg-primary/20 justify-start"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Upload or embed images</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Interactive reader polls</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Highlighted information</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Custom HTML code</span>
                          </div>
                        </Button>
                      </TabsContent>
                      
                      <TabsContent value="advanced" className="pt-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        <Button
                          variant="outline"
                          size="lg"
                          className="h-auto py-3 px-4 border-white/10 bg-[#14141E] hover:bg-white/10 justify-start"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Syntax highlighted code</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-white/60">Auto-generated TOC</span>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <div className="flex flex-col items-start text-left">
                            <div className="flex items-center mb-1">
                              <Columns className="h-4 w-4 mr-2 text-primary" /> 
                              <span className="font-medium">Columns</span>
                            </div>
                            <span className="text-xs text-white/60">Multi-column layout</span>
                          </div>
                        </Button>
                      </TabsContent>
                    </Tabs>
